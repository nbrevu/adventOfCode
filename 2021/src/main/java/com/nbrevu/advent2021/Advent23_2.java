...
public class Advent23_2 {
	...
	public static void main(String[] args) throws IOException	{
		...
		initialPods[0][1]=Amphipod.D;
		initialPods[1][1]=Amphipod.C;
		initialPods[2][1]=Amphipod.B;
		initialPods[3][1]=Amphipod.A;
		initialPods[0][2]=Amphipod.D;
		initialPods[1][2]=Amphipod.B;
		initialPods[2][2]=Amphipod.A;
		initialPods[3][2]=Amphipod.C;
