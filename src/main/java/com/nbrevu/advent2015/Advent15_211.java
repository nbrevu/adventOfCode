...
public class Advent15_211 {
	private final static String IN_FILE="2015/Advent211.txt";
	...
	public static Multimap<Integer,CharacterEquipment> getAllEquipmentCases()	{
		...
		Multimap<Integer,CharacterEquipment> result=MultimapBuilder.treeKeys().arrayListValues().build();
