...
public class Advent15_72 {
	private final static String IN_FILE="2015/Advent71.txt";
	private final static String FINAL_REGISTER="a";
	private final static Map<String,String> OVERRIDDEN_VALUES=ImmutableMap.of("b","956");
	...
	private static class Computer	{
		...
		public void parseInstruction(String instruction)	{
			...
			String override=OVERRIDDEN_VALUES.get(target);
			Evaluator evaluator=(override==null)?createEvaluator(split,split.length-2):new Literal(override);
			evaluators.put(target,evaluator);
		}
