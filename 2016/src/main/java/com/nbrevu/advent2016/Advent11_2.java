...
public class Advent11_2 {
	private static enum Element	{
		// I object to the usage of fictional elements. Physics and chemistry is already plentiful!
		TM,PU,SR,PM,RU,EL,DI;
	}
	...
	private static enum Microchip implements Item	{
		M_TM(Element.TM),M_PU(Element.PU),M_SR(Element.SR),M_PM(Element.PM),M_RU(Element.RU),M_EL(Element.EL),M_DI(Element.DI);
	...
	private static enum Generator implements Item	{
		G_TM(Element.TM),G_PU(Element.PU),G_SR(Element.SR),G_PM(Element.PM),G_RU(Element.RU),G_EL(Element.EL),G_DI(Element.DI);
		public final Element element;
	...
	public static void main(String[] args)	{
		FloorState floor1=new FloorState(Sets.newHashSet(Generator.G_TM,Microchip.M_TM,Generator.G_PU,Generator.G_SR,Generator.G_EL,Microchip.M_EL,Generator.G_DI,Microchip.M_DI));
