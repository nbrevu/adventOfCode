...
public class Advent4_2 {
	...
	private static class BestMinute	{
		public final Guard g;
		public final int minute;
		public final int dayCount;
		public BestMinute(Guard g,int minute,int dayCount)	{
			this.g=g;
			this.minute=minute;
	...
	private static class Guard	{
		...
		public BestMinute getBestMinute()	{
			int minute=0;
			int maxDayCounter=minuteCounters[0];
			for (int i=1;i<60;++i) if (minuteCounters[i]>maxDayCounter)	{
				minute=i;
				maxDayCounter=minuteCounters[i];
			}
			return new BestMinute(this,minute,maxDayCounter);
		}
	...
	public static void main(String[] args) throws IOException	{
		...
		BestMinute bestResult=null;
		for (Guard g:analyseLogs(sortedLog))	{
			BestMinute thisBest=g.getBestMinute();
			if ((bestResult==null)||(bestResult.dayCount<thisBest.dayCount)) bestResult=thisBest;
		}
